<template>
  <div>
    ...
    <div
      v-else-if="!cases?.content.length"
      class="text-muted-foreground text-sm py-8 border rounded-lg text-center"
    >
    ...
    <div v-else class="grid grid-cols-1 gap-3 pt-2">
      <ItemsIterator
        :items="cases.content"
        :totalElements="cases.totalElements"
            ...
            <CardContent class="text-sm space-y-1">
              <div class="flex items-center gap-4 text-muted-foreground">
                <span>
                  ...
                  Vence:
                  {{ new Date(item.dueDate).toLocaleDateString("es-GT") }}
                </span>
                <span>
              ...
              <div class="w-full bg-secondary rounded-full h-1.5 mt-1">
                <div
                  ...
                  :class="
                    item.progressPercent === 100 ? 'bg-green-500' : 'bg-primary'
                  "
