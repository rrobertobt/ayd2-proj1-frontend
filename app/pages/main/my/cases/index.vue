<template>
  <div>
    <h1 class="text-2xl font-bold mb-1 uppercase">Mis casos asignados</h1>
    <p class="text-muted-foreground mb-6">
      Casos en los que tienes al menos un paso asignado.
    </p>

    <div v-if="status === 'pending'" class="flex items-center gap-2 text-muted-foreground py-8">
...
const { data: cases, status } = await useAsyncData("my-cases", () =>
  casesApi.listMy(),
);
