  ...
  >
    ...
    <div class="space-y-2">
      ...
      >
        ...
        <NativeSelectOption value="OPEN">Abierto</NativeSelectOption>
    ...
    <div class="space-y-2">
      ...
      <NativeSelect
        :model-value="$route.query.sortBy || ''"
        @update:model-value="(val) => inputHandlers.sortBy(val)"
        class="w-full"
      >
        <NativeSelectOption value="">Creación</NativeSelectOption>
        <NativeSelectOption value="title">Título</NativeSelectOption>
        <NativeSelectOption value="status">Estado</NativeSelectOption>
        <NativeSelectOption value="dueDate">Fecha límite</NativeSelectOption>
      </NativeSelect>
    </div>
    ...
    <div class="space-y-2">
      ...
      <NativeSelect
        :model-value="$route.query.sortDir || ''"
        @update:model-value="(val) => inputHandlers.sortDir(val)"
        class="w-full"
      >
        <NativeSelectOption value="">Descendente</NativeSelectOption>
...
<script setup>
  ...
  const inputHandlers = {
    ...
    sortBy: createInputHandler("sortBy"),
    sortDir: createInputHandler("sortDir"),
  };
</script>
